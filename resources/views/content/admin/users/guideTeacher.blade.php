...
@section('title','Daftar Guru Bimbingan Konseling')
    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Tabel Guru Bimbingan Konseling</h3>
                <p class="text-subtitle text-muted">
                    Daftar nama guru bimbingan konseling
                </p>
            </div>
    ...
    <div class="row">
        <div class="col-md-12 col-12">
            <div class="card">
                ...
                <h5 class="card-title">Tabel Guru Bimbingan Konseling</h5>
                </div>
                <div class="card-body">
