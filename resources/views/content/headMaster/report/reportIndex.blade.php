                        ...
                        @foreach ($report as $item)
                            <tr>
                                ...
                                <td class="d-table-cell justify-content-center align-items-center">
                                    <a href="{{route('headMaster.reportShow', $item->id)}}" class="ms-1 btn btn-sm btn-info" data-bs-toggle="tooltip" data-bs-placement="top" title="Lihat detail">
                                        <i class="bi bi-info-circle"></i>
                                    </a>
                                    @if ($item->status != "selesai")
                                    <a href="{{route('headMaster.reportEdit', $item->id)}}" class="ms-1 btn btn-sm btn-primary" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
